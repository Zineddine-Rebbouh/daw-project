...
const Footer = () => {
    ...
    return (
        <div className='bg-[#06193B] mx-auto py-10 px-8 grid lg:grid-cols-3 gap-8 text-gray-300'>
            {/* Left section with brand and social icons */ }
            <div>
                <h1 className='w-full text-3xl lg:text-4xl xl:text-5xl font-bold text-[#00df9a]'>GAMEGUARD</h1>
                <p className='py-4'>
