    ...
    return (
        <div className='border-b-2 border-gray px-20'>
            <nav className="relative px-4 py-4 flex justify-between items-center bg-gray-50">
                ...
                <Link to="/Auth/register" className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-100 hover:bg-gray-100 text-gray-900 font-bold rounded-xl transition duration-200">
                    Sign In
                </Link>
                <Link to="/Auth/login" className="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-lg text-white font-bold rounded-xl transition duration-200">
                    Sign up
                </Link>
            </nav>
            {
