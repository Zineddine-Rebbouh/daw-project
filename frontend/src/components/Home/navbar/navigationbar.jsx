...
const NavigationBar = () => {
    ...
    const navLinks = [
        {
            name: 'Home', link: '/', icon: <IoHomeOutline size={ 30 } />
        },
        {
            name: 'About', link: '/About', icon: <FcAbout color='black' size={ 30 } />
        },
        {
            name: 'Services', link: '/Services', icon: <MdOutlineMiscellaneousServices size={ 30 } />
        },
        {
            name: 'Contact', link: '/Contact', icon: <RiContactsLine size={ 30 } />
        },
        {
            name: 'Quiz', link: '/quiz', icon: <RiContactsLine size={ 30 } />
        },
    ];
    ...
    return (
        <div className='border-b-2 border-gray px-20'> 
            <nav className="relative px-4 py-4 flex justify-between items-center bg-gray-50">
                ...
                <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6 gap-3">
                ...
                <Link to="/Auth/login" className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-100 hover:bg-gray-100 text-gray-900 font-bold rounded-xl transition duration-200">
                    Sign In
                </Link>
                <Link to="/Auth/register" className="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-lg text-white font-bold rounded-xl transition duration-200">
                    Sign up
                </Link>
            </nav>
            {
